...
function WheelGesturesPlugin(userOptions) {
  ...
  function init(embla, optionsHandler) {
    ...
    function addNativeMouseEventListeners() {
      (void 0).documentElement.addEventListener("mousemove", preventNativeMouseHandler, true);
      (void 0).documentElement.addEventListener("mouseup", preventNativeMouseHandler, true);
      (void 0).documentElement.addEventListener("mousedown", preventNativeMouseHandler, true);
    }
    function removeNativeMouseEventListeners() {
      (void 0).documentElement.removeEventListener("mousemove", preventNativeMouseHandler, true);
      (void 0).documentElement.removeEventListener("mouseup", preventNativeMouseHandler, true);
      (void 0).documentElement.removeEventListener("mousedown", preventNativeMouseHandler, true);
    }
...
//# sourceMappingURL=embla-carousel-wheel-gestures.esm-BXfSsESr.mjs.map
