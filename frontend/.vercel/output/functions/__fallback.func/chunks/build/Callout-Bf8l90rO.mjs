import { k as useComponentProps, l as useAppConfig, v as vueExports, t as tv, s as serverRenderer_cjs_prodExports, K as _sfc_main$v, f as _sfc_main$A } from './server.mjs';
...
const theme = {
  ...
  "variants": {
    "color": {
      ...
      "tertiary": {
        "base": "border border-tertiary/25 bg-tertiary/10 text-tertiary-600 dark:text-tertiary-300 [&_a]:text-tertiary [&_a]:hover:border-tertiary [&_a]:focus-visible:outline-tertiary [&_code]:text-tertiary-600 dark:[&_code]:text-tertiary-300 [&_code]:border-tertiary/25 [&_a]:hover:[&>code]:border-tertiary [&_a]:hover:[&>code]:text-tertiary [&_a]:focus-visible:[&>code]:border-tertiary [&_a]:focus-visible:[&>code]:text-tertiary [&>ul]:marker:text-tertiary/50",
        "icon": "text-tertiary",
        "externalIcon": "text-tertiary-600 dark:text-tertiary-300"
      },
      "info": {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "to": true,
      "class": {
        "base": "hover:border-tertiary has-focus-visible:border-tertiary",
        "externalIcon": "group-hover:text-tertiary"
      }
    },
    {
      "color": "info",
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = vueExports.computed(() => tv({ extend: tv(theme), ...appConfig.ui?.prose?.callout || {} })({
      color: props.color,
      to: !!props.to
    }));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vueExports.unref(props).to) {
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$v, vueExports.mergeProps({ to: vueExports.unref(props).to, target: target.value, ..._ctx.$attrs }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.1_@internation_af8eccc25614c82bd794e7ce0775ec2e/node_modules/@nuxt/ui/dist/runtime/components/prose/Callout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Callout-Bf8l90rO.mjs.map
