import { l as useAppConfig, v as vueExports, s as serverRenderer_cjs_prodExports, f as _sfc_main$A } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const icons = vueExports.computed(() => defu(appConfig.ui?.prose?.codeIcon || {}, theme));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (icon.value) {
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$A, vueExports.mergeProps({ name: icon.value }, _attrs), null, _parent));
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.1_@internation_af8eccc25614c82bd794e7ce0775ec2e/node_modules/@nuxt/ui/dist/runtime/components/prose/CodeIcon.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=CodeIcon-zNIMLtZb.mjs.map
