...
import { _ as _sfc_main$4 } from './Tabs-CWS-jJiK.mjs';
                  ...
                  if (item.value === "results") {
                    ...
                    serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(paginatedResults), (entry) => {
                      ...
                      if (entry.decreeConductLink) {
                        _push3(`<a${serverRenderer_cjs_prodExports.ssrRenderAttr("href", entry.decreeConductLink)} target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary-500 text-gray-900 dark:text-white hover:bg-primary-600 transition-colors text-sm"${_scopeId2}>`);
                        _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UIcon, {
                          name: "i-lucide-download",
                          class: "h-4 w-4"
                        }, null, _parent3, _scopeId2));
                        _push3(` Постановление о проведении </a>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      if (entry.decreeResultsLink) {
                        _push3(`<a${serverRenderer_cjs_prodExports.ssrRenderAttr("href", entry.decreeResultsLink)} target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary-500 text-gray-900 dark:text-white hover:bg-primary-600 transition-colors text-sm"${_scopeId2}>`);
                        _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UIcon, {
                          name: "i-lucide-download",
                          class: "h-4 w-4"
                        }, null, _parent3, _scopeId2));
                        _push3(` Постановление о результатах </a>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div></div>`);
                    ...
                    serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(paginatedRules), (entry) => {
                      ...
                      if (entry.link) {
                        _push3(`<a${serverRenderer_cjs_prodExports.ssrRenderAttr("href", entry.link)} target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary-500 text-gray-900 dark:text-white hover:bg-primary-600 transition-colors text-sm shrink-0"${_scopeId2}>`);
                        _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UIcon, {
                          name: "i-lucide-download",
                          class: "h-4 w-4"
                        }, null, _parent3, _scopeId2));
                    ...
                    item.value === "results" ? (vueExports.openBlock(), vueExports.createBlock("div", {
                      ...
                      (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(paginatedResults), (entry) => {
                        return vueExports.openBlock(), vueExports.createBlock("div", {
                          ...
                          vueExports.createVNode("div", { class: "flex flex-wrap gap-3" }, [
                            entry.decreeConductLink ? (vueExports.openBlock(), vueExports.createBlock("a", {
                              key: 0,
                              ...
                              vueExports.createTextVNode(" Постановление о проведении ")
                            ], 8, ["href"])) : vueExports.createCommentVNode("", true),
                            entry.decreeResultsLink ? (vueExports.openBlock(), vueExports.createBlock("a", {
                              key: 1,
                              ...
                              vueExports.createTextVNode(" Постановление о результатах ")
                            ], 8, ["href"])) : vueExports.createCommentVNode("", true)
                          ])
                        ]);
                      }), 128)),
                      ...
                      (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(paginatedRules), (entry) => {
                        return vueExports.openBlock(), vueExports.createBlock("div", {
                          ...
                          entry.link ? (vueExports.openBlock(), vueExports.createBlock("a", {
                            key: 0,
                            href: entry.link,
                            target: "_blank",
                            rel: "noopener noreferrer",
                            ...
                            vueExports.createTextVNode(" Скачать ")
                          ], 8, ["href"])) : vueExports.createCommentVNode("", true)
                        ]);
                      }), 128)),
...
//# sourceMappingURL=tenders-ALyVUxpW.mjs.map
