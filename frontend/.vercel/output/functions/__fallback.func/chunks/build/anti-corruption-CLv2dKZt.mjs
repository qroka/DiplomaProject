...
import { _ as _sfc_main$1 } from './Tabs-CWS-jJiK.mjs';
              ...
              content: vueExports.withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  serverRenderer_cjs_prodExports.ssrRenderList(docsByCategory(item.value), (doc) => {
                    ...
                    if (doc.file) {
                      _push3(`<a${serverRenderer_cjs_prodExports.ssrRenderAttr("href", doc.file)} target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary-500 text-gray-900 dark:text-white hover:bg-primary-600 transition-colors text-sm shrink-0"${_scopeId2}>`);
                    ...
                    vueExports.createVNode("div", { class: "mt-6 space-y-3" }, [
                      (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(docsByCategory(item.value), (doc) => {
                        return vueExports.openBlock(), vueExports.createBlock("div", {
                          ...
                          doc.file ? (vueExports.openBlock(), vueExports.createBlock("a", {
                            key: 0,
                            href: doc.file,
                            target: "_blank",
...
//# sourceMappingURL=anti-corruption-CLv2dKZt.mjs.map
