...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "w-4/5 mx-auto py-8" }, _attrs))}>`);
...
//# sourceMappingURL=contacts-De-NVZaA.mjs.map
