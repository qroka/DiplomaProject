import { v as vueExports, aV as injectRovingFocusGroupContext, a4 as useId, ac as useCollection, P as Primitive, aW as getFocusIntent, aX as wrapArray, aY as focusFirst$1 } from './server.mjs';
  ...
  setup(__props) {
    ...
    function handleKeydown(event) {
      ...
      if (focusIntent !== void 0) {
        ...
        vueExports.nextTick(() => focusFirst$1(candidateNodes));
      }
    }
    return (_ctx, _cache) => {
...
//# sourceMappingURL=RovingFocusItem-CItW57sS.mjs.map
