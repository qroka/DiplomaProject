const headOfDistrict = {
  role: "Глава Сургутского района",
  surname: "Трубецкой",
  name: "Андрей",
  patronymic: "Александрович",
  image: "/images/office.png",
  quote: "За каждым, даже скромным, улучшением жизни в Сургутском районе стоит конкретный человек в администрации Сургутского района. Мы верим, что вы внесёте свой вклад в развитие района и будете гордиться тем, что являетесь членом нашей команды."
};
const deputies = [
  {
...
const defaultIntro = "Отраслевой (функциональный) орган администрации Сургутского района обеспечивает реализацию полномочий в своей сфере деятельности и взаимодействует с жителями района.";
const departments = {
  "dep-vnutrenney-politiki": {
  ...
  "uo-organizacii-deyatelnosti": {
    ...
    intro: "Это настоящие «мозг» и «сердце» нашей команды! Их работа важна и многогранна. Это чёткий, отлаженный механизм, который регулирует деятельность всей администрации.",
    units: [
      "архивный отдел",
...
export { deputies as a, departments as d, getDepartment as g, headOfDistrict as h, socialLinks as s };
//# sourceMappingURL=departments-Ck1P6-b_.mjs.map
