  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.variant === "home") {
        ...
        if (vueExports.unref(resolvedImage)) {
          _push(`<div class="absolute inset-0 -z-10"><div class="absolute inset-0 bg-linear-to-r from-secondary-900/80 via-secondary-800/70 to-secondary-700/50"></div><img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", vueExports.unref(resolvedImage))}${serverRenderer_cjs_prodExports.ssrRenderAttr("alt", __props.imageAlt)} class="${serverRenderer_cjs_prodExports.ssrRenderClass([
            "h-full",
...
//# sourceMappingURL=PageHero-sozzGzkc.mjs.map
