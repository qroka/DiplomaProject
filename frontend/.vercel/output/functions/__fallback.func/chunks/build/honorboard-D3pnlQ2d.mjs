...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "w-4/5 mx-auto py-6" }, _attrs))}>`);
...
//# sourceMappingURL=honorboard-D3pnlQ2d.mjs.map
