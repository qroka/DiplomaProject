...
import { a as buildAssetsURL, G as publicAssetsURL, L as useRuntimeConfig, t as getResponseStatusText, s as getResponseStatus, l as encodePath, e as defineRenderHandler, q as getQuery, c as createError, j as destr, u as getRouteRules, A as joinURL, K as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/logos/logoASR.svg"},{"rel":"apple-touch-icon","href":"/logos/logoASR.svg"}],"style":[],"script":[],"noscript":[]};
