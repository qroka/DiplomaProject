...
name: ui-ux-pro-max
description: >-
  Searchable UI/UX design intelligence — styles, palettes, typography, UX
  guidelines, charts, and stack-specific rules. Use when designing, building,
  reviewing, or improving web/mobile interfaces.
---
...
- **Stack**: React, Vue, Next.js, Nuxt UI — for this project default to `nuxt-ui`
...
### Step 4: Stack Guidelines (Default: nuxt-ui for this project)

Get implementation-specific best practices. For **hr.admsr.ru** use `--stack nuxt-ui`; otherwise default to `html-tailwind`.

```bash
python .cursor/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack nuxt-ui
```
